#ifndef __MATCH_BASIC_CONFIG_LIST_H__
#define __MATCH_BASIC_CONFIG_LIST_H__
class MatchBasicConfigListRequest
{
public:
	MatchBasicConfigListRequest(const string& json) {
...
class MatchBasicConfigListResponse
{
public:
	MatchBasicConfigListResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
